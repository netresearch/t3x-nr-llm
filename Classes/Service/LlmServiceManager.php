...
final readonly class LlmServiceManager implements LlmServiceManagerInterface, SingletonInterface
{
     ...
     */
    private function assertContextPermitted(LlmConfiguration $configuration, array $metadata, int $agentRunUid = 0): void
    {
        ...
        $this->inputContextGate->assertPermitted($configuration, is_int($beUser) ? $beUser : 0, $agentRunUid);
    }
    ...
    private function runThroughPipeline(
        ...
        $this->assertContextPermitted($configuration, $metadata, $run->uid ?? 0);
