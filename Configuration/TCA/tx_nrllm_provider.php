...
return [
    ...
    'columns' => [
        ...
        'trust_zone' => [
            'label' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone',
            'description' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone.description',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
                    ['label' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone.local', 'value' => 'local'],
                    ['label' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone.privateHosted', 'value' => 'privateHosted'],
                    ['label' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone.externalEu', 'value' => 'externalEu'],
                    ['label' => 'LLL:EXT:nr_llm/Resources/Private/Language/locallang_tca.xlf:tx_nrllm_provider.trust_zone.externalGlobal', 'value' => 'externalGlobal'],
                ],
                'default' => 'externalGlobal',
                'required' => true,
            ],
        ],
        'endpoint_url' => [
