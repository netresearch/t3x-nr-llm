...
- **For general conduct issues:** Open a [GitHub Discussion](https://github.com/netresearch/t3x-nr-llm/discussions) or reach out privately to a maintainer.
- **For serious violations or safety concerns:** Use [GitHub Security Advisories](https://github.com/netresearch/t3x-nr-llm/security/advisories/new) for confidential reporting.
