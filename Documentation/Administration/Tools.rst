...
``attach_file_to_content_element`` and ``create_record_draft``. All nine
...
``create_page_draft``
   ...
   page into being (:ref:`ADR-180 <adr-180>`). It is bounded the same way the
