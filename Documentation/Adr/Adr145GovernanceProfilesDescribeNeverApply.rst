...
:Status: Accepted (the second gate this record named is wired in — see :ref:`ADR-148 <adr-148>`)
:Date: 2026-08-10
...
(:ref:`ADR-144 <adr-144>`) is answerable the same way and is not wired in yet.
