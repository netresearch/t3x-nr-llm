-- Seed data for local Ollama LLM development
-- This creates a pre-configured Ollama provider, model, and sample configurations
...
INSERT INTO tx_nrllm_model (
    ...
    'gemma3-1b',
    'Gemma 3 1B',
    'Google Gemma 3 with 1B parameters. Good quality for its size. February 2025 release.',
    @ollama_provider_uid,
    'gemma3:1b',
    32768,
    4096,
...
INSERT INTO tx_nrllm_configuration (
    ...
    'General-purpose configuration for local development and testing.',
    @default_model_uid,
...
INSERT INTO tx_nrllm_configuration (
    ...
    'Optimized for summarizing articles, documents, and content.',
    @default_model_uid,
...
INSERT INTO tx_nrllm_configuration (
    ...
    'Low temperature for precise code generation and explanations.',
    @default_model_uid,
    'You are a code assistant. Provide accurate, well-formatted code with clear explanations. Follow best practices and coding standards.',
    0.2,
    4096,
    0.8,
    180,
