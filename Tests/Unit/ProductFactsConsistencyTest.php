...
final class ProductFactsConsistencyTest extends AbstractUnitTestCase
{
    ...
    public function theCountersResolveTheWholeBuiltinDirectory(): void
    {
        ...
        // with them.
        self::assertSame(49, $this->totalToolCount(), 'Builtin tool count changed. Update every surface, then this number.');
        ...
        self::assertSame($this->totalToolCount(), $this->readOnlyToolCount() + 8, 'Exactly eight builtins write (ADR-134, ADR-135, ADR-146, ADR-180, ADR-192).');
    }
}
