...
final class ProductFactsConsistencyTest extends AbstractUnitTestCase
{
    ...
    public function theCountersResolveTheWholeBuiltinDirectory(): void
    {
        ...
        // with them.
        self::assertSame(50, $this->totalToolCount(), 'Builtin tool count changed. Update every surface, then this number.');
        ...
        self::assertSame($this->totalToolCount(), $this->readOnlyToolCount() + 9, 'Exactly nine builtins write (ADR-134, ADR-135, ADR-146, ADR-180, ADR-192, ADR-195).');
    }
}
