...
/**
 * Argument validation of `publish_record` (ADR-198).
 *
 ...
 * is exercised in {@see \Netresearch\NrLlm\Tests\Functional\Service\Tool\PublishRecordToolTest}.
 */
#[CoversClass(PublishRecordTool::class)]
final class PublishRecordToolTest extends AbstractUnitTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->tool = new PublishRecordTool(self::createStub(ConnectionPool::class));
    }
    ...
    public function theSpecNamesTheTwoTablesAndRequiresBothArguments(): void
    {
        ...
        self::assertSame('publish_record', $spec->name);
    ...
    public static function refusedArguments(): iterable
    {
        ...
        // Publishing is one flag; a model that asks to publish AND change
        // something else hears "no" rather than getting half of it.
        yield 'field smuggled in' => [['table' => 'pages', 'uid' => 1, 'starttime' => 0], 'not an argument of this tool'];
    }
